...
def test_guest_can_add_product_to_basket(browser, links):
    ...
    product_page.should_be_right_titles()
    product_page.should_be_right_prices()
...
class  TestUserAddToBasketFromProductPage:
    ...
    def test_user_can_add_product_to_basket(self, browser):
        ...
        self.product_page.should_be_add_to_basket()
        #product_page.solve_quiz_and_get_code()
        self.product_page.should_be_right_titles()
        self.product_page.should_be_right_prices()
